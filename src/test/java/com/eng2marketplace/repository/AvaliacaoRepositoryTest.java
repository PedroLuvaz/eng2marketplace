...
public class AvaliacaoRepositoryTest {
    ...
    public void testSalvar() {
        Avaliacao avaliacao = new Avaliacao("123456789", 10, "Muito bom");
        AvaliacaoRepository ar = new AvaliacaoRepository();
        ...
        assertEquals("Muito bom", avaliacoes.getFirst().getComentario());
        assertEquals(10, avaliacoes.get(0).getNota());
    }
    ...
    public void testRemover() {
        ...
        Avaliacao avaliacao2 = new Avaliacao("987654312", 0, "Horrivel");
        AvaliacaoRepository ar = new AvaliacaoRepository();
    ...
    void testRemoverPorCPFInvalido() {
        ...
        Avaliacao av2 = new Avaliacao("654321", 10, "%%%%%%%%");
        AvaliacaoRepository ar = new AvaliacaoRepository();
    ...
    @Test
    void testListar() {
        Avaliacao av = new Avaliacao("123456789", 9, "Bom");
        Avaliacao av2 = new Avaliacao("987654321", 8, "Gostei");
        AvaliacaoRepository ar = new AvaliacaoRepository();
    ...
    void testBuscarInvalido() {
        Avaliacao av = new Avaliacao("123", 10, "********");
        Avaliacao av2 = new Avaliacao("567", 6, "--------");
        AvaliacaoRepository ar = new AvaliacaoRepository();
    ...
    void testAtualizarInvalido() {
        ...
        ar.salvar(new Avaliacao("88888", 10, "////////"));
        ar.salvar(new Avaliacao("12345", 9, "########"));

        boolean result = ar.atualizar(new Avaliacao("1010101", 0,"++++++++"));
        assertFalse(result);
    ...
    void testLimpar() {
        ...
        ar.salvar(new Avaliacao("888", 6, "Mediano"));
        ar.salvar(new Avaliacao("777", 8, "Bom"));
